...
def load_test_questions(
    collection_name: str = "test_questions", persist_directory: str = "./chroma_data"
) -> ChromaVectorDB:
    ...
    metadatas = [
        {"question_id": i, "type": "test_question"} for i in range(len(TEST_QUESTIONS))
    ]
...
def query_similar_questions(
    query: str, db: ChromaVectorDB, n_results: int = 3
) -> List[Dict]:
