...
def test_generate_valid_prompt():
    ...
    response = app.test_client().post('/generate', data=json.dumps(prompt), content_type='application/json')
...
def test_generate_invalid_prompt():
    ...
    response = app.test_client().post('/generate', data=json.dumps(invalid_prompt), content_type='application/json')
