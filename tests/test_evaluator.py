...
from model_evaluator import extract_structured_answer, strict_format_reward_func, soft_format_reward_func, test_model
...
def mock_fast_language_model():
    ...
    mock_tokenizer.decode.return_value = "<reasoning>\nTest reasoning\n</reasoning>\n<answer>\nTest answer\n</answer>"
