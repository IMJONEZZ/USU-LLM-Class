...
from rileyassn7 import embed_model, vector_store, query_vector_db
...
def setup_vector_db(sample_data):
    ...
    test_vector_store = Chroma(persist_directory="./test_chroma_db", embedding_function=embed_model)
