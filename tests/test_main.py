...
def test_load_data(mock_json_load, mock_open):
    ...
    mock_json_load.return_value = [{"Line": "Hello world."}, {"Line": "ZenML is great!"}]
...
def test_encode_text():
    ...
    expected_tokens = [tokenizer.encode(sentence, add_special_tokens=True) for sentence in SAMPLE_TEXT.split(".") if sentence.strip()]
    ...
    assert result == expected_tokens, f"Tokenized output mismatch! Expected {expected_tokens}, got {result}"
